...
app.post("/upload", async (req, res) => {
  ...
  const productImage = await uploadImageToCloudinary(product, "BuyLow");
  res.json({
    success: 1,
    image_url: productImage.secure_url,
  });
});
...
app.post("/addproduct", async (req, res) => {
  ...
  console.log(product);
  await product.save(); //await has been removed by manan arora
  console.log("Saved");
